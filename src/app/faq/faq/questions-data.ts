export const QUESTIONS = [
  {
    ...
    description:
      'Angular is a platform for developing web and mobile applications. It is developed at Google and supported by a worldwide community. Today, Angular is one of the most popular development technologies.',
  },
  {
  ...
  },
  {
    ...
    description:
      'This is a 2-day event. The first day we will have 4 workshops. The second day we will have keynotes and talks.',
  },
  {
    title: '4. Where can I purchase my ticket?',
    description:
  ...
  {
    title: '5. How many tickets can I purchase per transaction?',
    description:
